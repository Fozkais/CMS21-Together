...
{
    public static class CustomUILobby
    {
        ...
        public static void InitializeLobbyMenu()
        {
            ...
            CustomUIBuilder.CreateNewButton(UISection.MP_Lobby, b1_info, false); 
            ...
            CustomUIBuilder.CreateNewButton(UISection.MP_Lobby, b2_info, false); 
            ...
            CustomUIBuilder.CreateNewButton(UISection.MP_Lobby, b3_info, false); // Need to be last

            CustomUIBuilder.BuildLobbyHeader();
            
            
            CustomUIManager.DisableUI(UISection.MP_Lobby);
        }
        ...
        public static void AddPlayerToLobby(string username, int index)
        {
            ...
            img.rectTransform.parent = CustomUIBuilder.GetParentFromSection(UISection.MP_Lobby);
            img.rectTransform.parentInternal = CustomUIBuilder.GetParentFromSection(UISection.MP_Lobby);
